...
insert_data(cur, df_colaboradores, "gestao_competencia_colaborador", "id,nome, area_id, email", ["id_colab", "nome_colab", "id_area", "email"])
insert_data(cur, df_soft_skills, "gestao_competencia_softskill", "id,nome,area_id", ["id_soft_skill", "nome_soft_skill", "id_area"])
insert_data(cur, df_hard_skills, "gestao_competencia_hardskill", "id,nome,area_id", ["id_hard_skill", "nome_hard_skill", "id_area"])
